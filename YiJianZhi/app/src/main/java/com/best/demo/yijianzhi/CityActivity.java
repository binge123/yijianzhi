...
import com.best.bean.City;
import com.best.sqlite.DBHelper;
import com.best.sqlite.DatabaseHelper;
import com.best.utils.MyLetterListView;
import com.best.utils.PingYinUtil;

/**
 * Created by dell2 on 2015/11/24.
 */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        personList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position >= 4) {
                    intent.putExtra("test",allCity_lists.get(position).getName());
        ...
        resultList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                                    int position, long id) {
                intent.putExtra("test",city_result.get(position).getName());
                intent.putExtra("index",1);
                startActivity(intent);
                Toast.makeText(getApplicationContext(),
...
//                    pbLocate.setVisibility(View.GONE);
                ...
                rencentCity.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                                            int position, long id) {
                        intent.putExtra("test",city_history.get(position));
                        intent.putExtra("index",1);
                        startActivity(intent);
                        Toast.makeText(getApplicationContext(),
                ...
                hotCity.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                                            int position, long id) {
                        intent.putExtra("test",city_hot.get(position).getName());
                        intent.putExtra("index",1);
                        startActivity(intent);
                        Toast.makeText(getApplicationContext(),
